...
public class PhotoPreference {
    ...
    private static final String GROUP_PHOTO = "cl.empresapjm.prueba3fullscreen.data.KEY.GROUP_PHOTO";
    private static final String KEY_PHOTO = "cl.empresapjm.prueba3fullscreen.data.KEY.KEY_PHOTO";
