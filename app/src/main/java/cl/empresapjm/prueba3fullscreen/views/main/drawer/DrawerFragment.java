...
import cl.empresapjm.prueba3fullscreen.views.login.LoginActivity;
...
public class DrawerFragment extends Fragment implements PhotoCallback {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (RESULT_OK == resultCode){
            ...
            String path = magicalCamera.savePhotoInMemoryDevice(photo, "avatar", "prueba3", MagicalCamera.JPEG,true);
